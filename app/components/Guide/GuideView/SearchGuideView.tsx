    ...
    <>
      ...
      >
        <div style={{ padding: "0 20px", marginBottom: 20 }}>
          ...
          <div style={{ marginBottom: 32 }}>
            <S.ExtraDescriptionSection>
              ...
              <ul>
                {[
                  "🟢 초록색: 접근이 쉬워요 (계단이 없거나 경사로가 있어요)",
                  "🟡 노란색: 계단이 1칸 이상 있어요",
                  "🔴 빨간색: 계단이 5칸 이상이거나 엘리베이터가 없어요",
                ].map((desc, idx) => (
                  <S.ExtraDescriptionItem key={`$scc-road-desc-${idx}`}>
        ...
        <div style={{ padding: "0 20px", marginTop: 48, marginBottom: 20 }}>
          ...
          <GuideTypography variant="description">검색 필터를 활용하면,</GuideTypography>
          <GuideTypography variant="description">조건에 맞는 장소만 골라서 확인할 수 있어요.</GuideTypography>
        </div>
      ...
      >
        <div style={{ padding: "0 20px", marginBottom: 20 }}>
          ...
          <GuideTypography variant="description">
            뿌클로드는 이동약자와 친구들이 직접 남긴 장소 리뷰예요.
          </GuideTypography>
          <GuideTypography variant="description">매장 내부부터 주차장, 화장실까지 생생한 접근 정보를</GuideTypography>
          ...
          <GuideTypography variant="description">앱 메뉴에서 뿌클로드에 들어가면</GuideTypography>
          <GuideTypography variant="description">
